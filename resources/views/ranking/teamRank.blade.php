...
<div class="wrapper d-flex align-items-stretch">
      ...
      <center><h2 class="mb-4">Team General Ranking</h2></center>
      <table border="1">
    <thead>
        <tr>
            <th>Team Rank</th>
            <th>Team Name</th>
            <th>Total Points</th>
            <th>Download PDF Certificate</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($teamRanks as $teamRank)
            <tr>
                ...
                <td>
                    <a href="{{ route('teamStagePoints', ['team_name' => $teamRank->team_name]) }}">
                        {{ $teamRank->team_name }}
                    </a>
                </td>
                ...
                <td>
                    @if($teamRank->team_rank == 1)
                        <a href="{{ route('downloadCertificate', ['team' => $teamRank->team_name, 'category' => 'All Category']) }}">Download PDF</a>  
                    @endif
                </td>
            </tr>
        @endforeach
